...
class SegmentPB : View, Runnable, View.OnTouchListener {
    ...
    var segmentBackgroundColor: Int = Color.GRAY
        private set
    var segmentSelectedBackgroundColor: Int = context.resources.getColor(R.color.grey)
        private set
    var segmentStrokeColor: Int = Color.WHITE
        private set
    ...
    private val pageCallback = object : ViewPager2.OnPageChangeCallback() {
        ...
        override fun onPageSelected(position: Int) { setPosition(position) }
    }
    ...
    var viewPager: ViewPager2? = null
        ...
        set(value) {
            viewPager?.let {
                pause()
                it.unregisterOnPageChangeCallback(pageCallback)
